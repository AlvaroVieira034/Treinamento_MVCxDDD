...
type
  ...
  public
    function ConsultarCep(Cep: string; FormatoJSON: Boolean): string;
    function ConsultarEndereco(Logradouro, Cidade, Estado: string; FormatoJSON: Boolean): string;
...
function TCEPService.ConsultarCEP(Cep: string; FormatoJSON: Boolean): string;
...
function TCEPService.ConsultarEndereco(Logradouro, Cidade, Estado: string; FormatoJSON: Boolean): string;
var
